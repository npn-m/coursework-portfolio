...
<body>
    <header>
        <div class="navbar">
            ...
            <ul>
                <span class="material-symbols-outlined">home</span><t><a href="#">HOME</a></t>
                <t><a href="#">VTUBER</a></t>
                <t><a href="#">ARTIST</a></t>
                ...
                <t><button class="login">Login</button></t>
                <t><button class="signup">Sign Up</button></t>
    ...
    <main>
        <section class="signup-section">
            ...
            <div class="signup-box">
                ...
                <input name="phone_num" type="tel" placeholder="Phone Number" required />
