...
<body>
    ...
    <main>
        ...
        <div class="cms-header"><label>My Commission</label></div>  
        
        <div class="cms-section">
            <a href="add-cms.php"><span class="material-symbols-outlined">add</span></a>
            <div class="commission-card">
                <div class="image-placeholder" src="painting.jpg"></div>
                <p>Commission Rate Price</p>
                <p>Commission Name / Detail</p>
            </div>
            <div class="commission-card">
                <div class="image-placeholder" src="painting.jpg"></div>
                <p>Commission Rate Price</p>
        ...
        <a href="artist.php"><button class="confirm-btn">Confirm</button></a>
