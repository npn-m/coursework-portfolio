    ...
    <div class="profile-header">
        ...
        <div class="profile-info">
            <div class="details">
                <h2>Account Name 
                    <span>@username </span> 
                    <a href="artist_edit.php"> <span class="material-symbols-outlined">edit_square</span></a>
                </h2>
                <br><p>subscribe count · user category</p></br>
            </div>
            <a href="artist_edit.php" style="color:white;">
    ...
    <div class="content-profile">
        ...
        <div class="commission-section">
            <div class="commission-list">
                <img class="image-placeholder" src="painting.jpg"></img>
                <p>Commission Price</p>
                <p1>Commission Name / Detail</p1>
            </div>
            <div class="commission-list">
                <img class="image-placeholder" src="painting.jpg"></img>
                <p>Commission Price</p>
